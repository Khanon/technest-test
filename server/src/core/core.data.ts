import { AccountTransactionCodes, AccountTransactionTypes } from '../models/transaction.model';
import { AccountInterface, AccountCategories, AccountTags } from '../models/account.model';
import { CurrencyId } from '../models/currency.model';
import { AccountTransactionInterface } from '../models/transaction.model';
...
export class CoreData {
    ...
    constructor() {
        ...
        let index = 0;
        do {
            this.accounts.push(this.getRandomAccount(index));
            index++;
        } while (index < 50);
    }

    private getRandomAccount(index: number): AccountInterface {
